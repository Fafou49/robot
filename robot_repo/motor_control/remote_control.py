...
class Remote:
    ...
    @property
    def gamepad(self):
        """Public read-only access to the underlying GamepadReader --
        added (2026-09-11) so callers like the gps_log_on_full_*.py
        scripts can reach start_rumble()/stop_rumble() without poking at
        the underscore-prefixed _gamepad attribute directly."""
